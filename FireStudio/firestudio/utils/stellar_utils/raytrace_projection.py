...
from FireStudio.firestudio.utils.stellar_utils.colors_sps.colors_table import colors_table
from FireStudio.firestudio.utils.stellar_utils.attenuation.cross_section import opacity_per_solar_metallicity
